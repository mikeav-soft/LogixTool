...
namespace LogixTool
{
    public static class Strings
    {
        ...
        /// <param name="c"></param>
        /// <returns></returns>
        public static bool IsLaterOrDigit(this char c)
        {
            return IsDigit(c) || IsLater(c);
        }
        /// <summary>
        /// 
        /// </summary>
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsLatersOrDigits(this string s)
        {
            return IsDigits(s) || IsLaters(s);
        }
        /// <summary>
        /// 
        /// </summary>
        /// <param name="c"></param>
        /// <returns></returns>
        public static bool IsLater(this Char c)
        {
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsLaters(this String s)
        {
            if (s == null)
            {
                return false;
